...
- **Scratchpad:**
  - Create a scratchpad file to jot down notes in `docs/scratchpad/add_scratchpad.md`, to keep track of important points, questions, and insights that arise during the conversation.
  ...
  - Use the scratchpad to jot down notes, located in `docs/scratchpad/add_scratchpad.md`, to keep track of important points, questions, and insights that arise during the conversation.
