...
OPTIONALLY READ `docs/examples/genai_launchpad_workflow_architecture.md` for workflow-based architecture patterns (useful for AI pipelines and DAG-based systems).
